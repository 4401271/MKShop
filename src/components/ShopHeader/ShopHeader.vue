      ...
      <div class="activity-sheet" v-show="isShowSupports">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont iconguanbi" @click="isShowSupports=false"></span>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...mapState({
      // 因为数据结构发生了改变，state.shop取到的vuex中的modules下的shop，再取出其中的shop状态，这个状态中存储的就是shops.json中存储的数据，这个数据有三个板块，其中info就是我们想要的
