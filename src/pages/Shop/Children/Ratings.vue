        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'iconlike-full' : 'iconbadreview-full'"></span>
  ...
  computed: {
    ...
    filterRatings () {
      ...
      return ratings.filter(rating => {
         ...
         */
        // 被成功筛选的条件：全选/用户点击“是否满意”与该评论中买家“是否满意”相同 且 用户未点击“只看有内容的评论”/用户点击了”只看有内容的评论“且评论长度>0
    ...
    .rating-item
      ...
      .content
        ...
        .recommend
          line-height: 16px
          font-size: 0
          .iconlike-full, .iconbadreview-full, .item
            display: inline-block
            margin: 0 8px 4px 0
            font-size: 9px
          .iconlike-full
